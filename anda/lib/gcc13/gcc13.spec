...
AutoReq: true
AutoProv: false
Conflicts: gcc%{new_major}-gfortran
...
%changelog
* Thu Feb 27 2025 ShinyGil <rockgrub@disroot.org> - 13.3.1-2.1
- Ported from Fedora 41 for NVCC and CUDA
